...
export function About() {
  return (
    <Parallax
      ...
      bgImageStyle={{
        objectFit: "cover", // Set image to cover the container
            ...
            <VerticalTimeline lineColor="#3a4664">
              ...
              >
                ...
                <p style={{ fontWeight: "300" }}>
                  Pertemuan tak terduga di kantin sekolah menjadi awal kisah
                  cinta kita.
                </p>
              </VerticalTimelineElement>
              ...
              >
                ...
                <p style={{ fontWeight: "300" }}>
                  Menjadi bab terpisah dalam kisah cinta kami, namun akhirnya
